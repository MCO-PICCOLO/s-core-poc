...
**NEW**: Now includes Health Monitor integration for production deployment with Launch Manager supervision. See [HEALTH_MONITOR_INTEGRATION.md](HEALTH_MONITOR_INTEGRATION.md) for details.

## Features

- **Fixed Execution Order (FEO)**: Deterministic activity scheduling
- **Multi-Agent Architecture**: Primary agent + 2 secondary agents
- **Health Monitoring**: Integrated deadline supervision and failure detection
- **Launch Manager Integration**: Automatic process recovery and lifecycle management
- **Configurable**: Cycle time and HM thresholds adjustable via config files

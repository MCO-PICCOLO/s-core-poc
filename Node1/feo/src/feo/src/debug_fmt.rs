...
impl<'a, T: ScoreDebug> core::fmt::Debug for ScoreDebugHashSet<'a, T> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{{...}}")
    }
}
impl<'a, T: ScoreDebug> core::fmt::Display for ScoreDebugHashSet<'a, T> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{{...}}")
    }
}
...
impl<'a, T: ScoreDebug> core::fmt::Debug for ScoreDebugBTreeSet<'a, T> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "[...]")
    }
}
impl<'a, T: ScoreDebug> core::fmt::Display for ScoreDebugBTreeSet<'a, T> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "[...]")
    }
}
...
impl<'a, T: core::fmt::Debug, const MAX_LENGTH: usize> core::fmt::Debug for ScoreDebugDebug<'a, T, MAX_LENGTH> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{:?}", self.0)
    }
}

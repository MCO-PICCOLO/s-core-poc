...
# Find bpftool dynamically - try multiple locations
...
# If not found in standard paths, search in kernel-specific directories

if(NOT BPFTOOL)

    execute_process(

        COMMAND bash -c "find /usr/lib -name bpftool -type f -executable 2>/dev/null | head -1"

        OUTPUT_VARIABLE BPFTOOL
...
if(NOT BPFTOOL OR "${BPFTOOL}" STREQUAL "")

    message(FATAL_ERROR "bpftool not found. Please install linux-tools-generic or linux-tools-$(uname -r)")
...
add_custom_command(OUTPUT ${SKEL_HDR}
        ...
        # Use the dynamically found bpftool binary
